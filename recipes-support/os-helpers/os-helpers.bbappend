...
BOOTLOADER_IMAGE ?= "imx-boot-${MACHINE}-sd.bin-flash_evk"
BOOTLOADER_IMAGE:imx8mp-var-dart-pl1000pp = "imx-boot.bin"
...
do_install:append() {
	...
	sed -i -e "s,@@BOOTLOADER_IMAGE@@,${BOOTLOADER_IMAGE},g" ${D}${libexecdir}/os-helpers-sb
