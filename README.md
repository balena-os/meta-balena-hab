...
* **Command Sequence File (CDF) description template**: Read by the boot ROM during the boot process, it determines how to validate artifacts by specifying the commands and parameters needed.
...
* Disabling JTAG debugging
* Disabling external memory boot
